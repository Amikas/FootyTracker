...
export default function ActivityDisplay() {
  ...
  if (!memoizedActivityData) return <div className="text-gray-500">No activity data available</div>

  const { summary, activities } = memoizedActivityData
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        >
          ...
          <p className="text-3xl font-bold">{summary?.steps ?? 0}</p>
        </motion.div>
        ...
        >
          ...
          <p className="text-3xl font-bold">
            {summary?.distances[0]?.distance ?? 0} km
          </p>
        </motion.div>
